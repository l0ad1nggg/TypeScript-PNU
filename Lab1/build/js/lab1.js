...
function typeCheck(value1, value1_type, value2, value2_type) {
    ...
    if ((value1_type === "hypotenuse" && !["leg", "angle"].includes(value2_type)) ||
        (value2_type === "hypotenuse" && !["leg", "angle"].includes(value1_type))) {
        message += "Hypotenuse must be with leg or angle\n";
    }
    if ((value1_type === "leg" &&
        !["leg", "hypotenuse", "adjacent angle", "opposite angle"].includes(value2_type)) ||
        (value2_type === "leg" &&
            !["leg", "hypotenuse", "adjacent angle", "opposite angle"].includes(value1_type))) {
